...
#if defined(ESP32)
// select one and adapt to your mapping, can use full buffer size (full HEIGHT)
//GxEPD2_BW<GxEPD2_154, GxEPD2_154::HEIGHT> display(GxEPD2_154(/*CS=5 Was SS*/ 14, /*DC=*/ 17, /*RST=*/ 16, /*BUSY=*/ 4)); // GDEP015OC1 no longer available



/* Remapping some of the pins to work with the other devices we have in the system.
 *  Original config:
 *  
  */
...
//GxEPD2_BW<GxEPD2_154_D67, GxEPD2_154_D67::HEIGHT> display(GxEPD2_154_D67(/*CS=5*/ 15, /*DC=*/ 4, /*RST=*/ 8, /*BUSY=*/ 2)); // GDEH0154D67

GxEPD2_BW<GxEPD2_154, GxEPD2_154::HEIGHT> display(GxEPD2_154(/*CS=5*/ 26, /*DC=*/ 5, /*RST=*/ 0, /*BUSY=*/ 2)); // GDEH0154D67
